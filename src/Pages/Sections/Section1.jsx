...
const Section1 = () => {
  return (
    <div className="w-[96%] mx-auto  max-w-[1140px] mb-16">
      <div className="w-full mx-auto md:flex flex-row justify-between items-center  mt-10">
        <div className="mr-5">
          ...
          <div
            ...
            className="rounded-lg p-2 mt-6 w-full lg:w-[350px] lg:h-[60px]"
          >
