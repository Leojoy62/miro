...
const Section7 = () => {
  return (
    <div className="w-[96%] mx-auto px-2 lg:w-[1140px] md:ml-16 mt-32 ">
      ...
      <div className="grid grid-cols-3 gap-2 md:flex justify-start md:gap-6 mt-10">
      ...
      <div className="md:flex mt-10 sm:flex-col sm:items-center md:flex-row ">
        <div className="md:mr-10 md:mt-10 md:w-1/5">
          ...
          <p className="text-gray-500 mt-2 flex gap-2 ">
            <TiTick className="text-2xl md:text-4xl mr-2" /> Involve
            stakeholders in the design process
          </p>
          <p className="text-gray-500 mt-2 flex gap-2 ">
            <TiTick className="text-2xl md:text-3xl mr-2" /> Run engaging design
            workshops
          </p>
